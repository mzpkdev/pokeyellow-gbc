...
DEF BIT_PASSIVE_FULL_COLOR_OVERLAY_FINITE_SWEEP EQU 3
DEF BIT_PASSIVE_FULL_COLOR_OVERLAY_STOCK_SWEEP EQU 4
DEF BIT_PASSIVE_FULL_COLOR_OVERLAY_COMPLETE EQU 5
DEF BIT_PASSIVE_FULL_COLOR_OVERLAY_ATTRIBUTE_GDMA EQU 7
