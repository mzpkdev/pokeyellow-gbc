...
; The inverse encoding makes cleared/new save data select Color by default.
DEF BIT_COLOR_MODE_YELLOW EQU 0
DEF COLOR_MODE_COLOR      EQU 0
DEF COLOR_MODE_YELLOW     EQU 1
