...
This is a historical ledger of defects inherited from the original Pokémon Yellow code. It is not a color-renderer failure log or a general ROMhack issue tracker; use [Development Workflow](DEVELOPMENT_WORKFLOW.md) for current regression triage and record active work in its owning issue or pull request.
...
**Fix:** TBD in [engine/pikachu/pikachu_follow.asm#L1165](../engine/pikachu/pikachu_follow.asm#L1165)
